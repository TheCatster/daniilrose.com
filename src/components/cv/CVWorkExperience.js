...
const CVEducation = () => {
  return (
    <div>
      ...
      <p className="cv-text">
        Created the database interface, blog, and web store in PHP, Laravel, and
        Vue.js.
      </p>
      ...
      <p className="cv-text">
        Responsible for PCB design, Linux development, signals and 3D modeling.
        Embedded software development and robotics in C, Rust, and Python.
      </p>

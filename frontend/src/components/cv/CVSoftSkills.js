    ...
    <div>
      ...
      <div className="container p-2">
        <ul className="cv-list list-disc list-outside text-left">
          ...
          <li className="cv-list-item">Sharing knowledge with others.</li>
          <li className="cv-list-item">
            Time management and ability to work with others and independently.
          </li>
        </ul>
      </div>
    </div>
